...
const dictionaries = {
  en: {
    ...
    embeds: {
      ...
      supportTitle: 'TunixBot Support',
      supportMessage: 'Need help or want to report a problem? Join the official support server:\n{url}',
      supportButton: 'Open Support Server',
      voteTitle: 'Vote for TunixBot',
      voteMessage: 'You can support TunixBot by voting on Top.gg:\n{url}',
      voteButton: 'Vote on Top.gg',
    ...
    dashboard: {
      ...
      spotifyPlaylistTracksFailed: 'Failed to load Spotify playlist tracks',
    ...
    commands: {
      ...
      supportDescription: 'Get the official TunixBot support server.',
      voteDescription: 'Support TunixBot by voting on Top.gg.',
      optionQuery: 'Title, YouTube URL or Spotify URL',
      optionSource: 'Search source',
      optionFilter: 'Filter',
  ...
  it: {
    ...
    embeds: {
      ...
      supportTitle: 'Supporto TunixBot',
      supportMessage: 'Ti serve aiuto o vuoi segnalare un problema? Entra nel server supporto ufficiale:\n{url}',
      supportButton: 'Apri Server Supporto',
      voteTitle: 'Vota TunixBot',
      voteMessage: 'Puoi supportare TunixBot votando su Top.gg:\n{url}',
      voteButton: 'Vota su Top.gg',
      dashboardButton: 'Dashboard',
      queueButton: 'Coda',
      pauseButton: 'Pausa',
      resumeButton: 'Resume',
    ...
    dashboard: {
      ...
      spotifyPlaylistTracksFailed: 'Impossibile caricare i brani della playlist Spotify',
    ...
    commands: {
      ...
      supportDescription: 'Mostra il server supporto ufficiale di TunixBot.',
      voteDescription: 'Supporta TunixBot votando su Top.gg.',
      optionQuery: 'Titolo, URL YouTube o URL Spotify',
      optionSource: 'Sorgente ricerca',
      optionFilter: 'Filtro',
